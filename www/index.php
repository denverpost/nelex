            ...
            <main class="maincol small-12 large-9 medium-8 columns">
                ...
                <div class="row">                    
                    <div class="large-10 large-centered columns">
                        ...
                        <?php } ?>
                        <?php if ($is_iframe === false && $is_homepage === true) { ?>
                ...
                <script id="results-template" type="text/x-handlebars-template">
                    ...
                    <div class="race-wrap">
                        ...
                        <table class="results-table fixed-width">
                            ...
                            <tbody>
                                {{#eachByVotePct results "choice_vote_percent"}}
                                <tr>
